...
class ClamAVView:
    ...
    def show_about_window(self, version):
        ...
        try:
            ...
            image_label.image = about_image  # ¡Importante! Mantener la referencia a la imagen. / Important! Keep the reference to the image.
    ...
    def show_history_window(self, history_files):
        ...
        listbox.bind('<Double-Button-1>', lambda e: self.controller.open_history_file(listbox))
